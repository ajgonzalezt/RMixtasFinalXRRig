...

{
    ...
    void Update()
    {
        ...
        if (GameManager.Instance != null && transform.tag == "active" && GameManager.Instance.isInSwapTransition1)
        {
            ...
            if (Vector3.Distance(GameManager.Instance.point2_T1.position, GameManager.Instance.XRRig.transform.position) < 0.6)
            {
            ...
            if (Vector3.Distance(GameManager.Instance.point3_T2.position, GameManager.Instance.currentCharacter.transform.position) < 0.6)
            {
